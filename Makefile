...
CFILES_BONUS := main_bonus.c init_bonus.c utils_bonus.c free_memory_bonus.c \
                validation_bonus/validation_bonus.c validation_bonus/check_rgb_bonus.c validation_bonus/data_processing_bonus.c validation_bonus/check_path_bonus.c validation_bonus/map_bonus.c validation_bonus/map_utils_bonus.c validation_bonus/check_wall_bonus.c validation_bonus/tab_bonus.c \
